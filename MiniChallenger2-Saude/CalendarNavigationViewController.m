//
//  CalendarNavigationViewController.m
...
@interface CalendarNavigationViewController ()

@end

@implementation CalendarNavigationViewController
...
-(instancetype)init
{
    ...
    if (self) {
        ...
        NSString *title = @"Calendário";
        UITabBarItem* tBItem = [[UITabBarItem alloc] initWithTitle:title image:[UIImage imageNamed:@"calendar"] selectedImage:[UIImage imageNamed:@"calendar"]];
